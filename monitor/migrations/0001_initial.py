# Generated by Django 2.1 on 2019-03-08 15:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('body_type', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='monitor.BodyType')),
                ('control', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='monitor.Control')),
            ],
        ),
        migrations.CreateModel(
            name='ProblemStatus',
        ...
        migrations.AddField(
            model_name='problem',
            name='unit',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='monitor.Unit'),
        ),
        migrations.AddField(
            model_name='alert',
            name='alert_type',
